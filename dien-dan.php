        ...
        <div class="row">
            <div class="col">
			    <div class="box-stt">
                    ...
                    <div class="box-right">
                        <a href="bang-xep-hang" class="important"> Bảng Xếp Hạng<img src="image/hot.gif"></a>
                        <div class="box-name" style="font-size: 9px;"> bởi admin </div>
                    </div>
                </div>
				<div class="box-stt">
                    <div style="width: 40px; float:left; margin-right: 5px;">
                        <img src="image/avatar9.png" style="width: 35px">
                    </div>
                    <div class="box-right">
                        <a href="giftcode" class="important"> Giftcode <img src="image/hot.gif"></a>
                        <div class="box-name" style="font-size: 9px;"> bởi admin </div>
                    </div>
